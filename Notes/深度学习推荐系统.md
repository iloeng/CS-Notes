...
* Question
  * figure 7 为什么RQ-KMeans的embedding hit rate要好于RQ-VAE，很奇怪呀，理论上他俩的embedding是同一个经过i2i微调的embedding吧
...
#### UniDex：利用 SID 优化 Inverted Index

> https://arxiv.org/html/2509.24632v1

* 两个组件
  * UniTouch, which maps queries and documents into semantic IDs for improved retrieval
  * UniRank, which employs semantic matching to rank results effectively
